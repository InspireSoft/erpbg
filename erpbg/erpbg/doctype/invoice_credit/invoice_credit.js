...
erpnext.accounts.InvoiceCreditController = erpnext.selling.SellingController.extend({
	setup: function(doc) {
...
$.extend(cur_frm.cscript, new erpnext.accounts.InvoiceCreditController({frm: cur_frm}));
...
frappe.ui.form.on('Invoice Credit', {
	setup: function(frm){
		// expense account
