...
function set_values_from_item(cdt, cdn, soi) {
    ...
    frappe.model.set_value(cdt, cdn, "gabarit_6irina", soi.gabarit_6irina);
    frappe.model.set_value(cdt, cdn, "gabarit_viso4ina", soi.gabarit_viso4ina);
    frappe.model.set_value(cdt, cdn, "gabarit_dulbo4ina", soi.gabarit_dulbo4ina);
    frappe.model.set_value(cdt, cdn, "grub_viso4ina", soi.grub_viso4ina);
    frappe.model.set_value(cdt, cdn, "dulbo4ina_na_sqdane", soi.dulbo4ina_na_sqdane);
    frappe.model.set_value(cdt, cdn, "oblegalka_6irina_gore", soi.oblegalka_6irina_gore);
    frappe.model.set_value(cdt, cdn, "oblegalka_6irina_dolu", soi.oblegalka_6irina_dolu);
    frappe.model.set_value(cdt, cdn, "oblegalka_ugul", soi.oblegalka_ugul);
    frappe.model.set_value(cdt, cdn, "grub_6irina", soi.grub_6irina);
    frappe.model.set_value(cdt, cdn, "tabla_or_vuzglavnica_model", soi.tabla_or_vuzglavnica_model);
    frappe.model.set_value(cdt, cdn, "spalnq", soi.spalnq);
    frappe.model.set_value(cdt, cdn, "tabla", soi.tabla);
    frappe.model.set_value(cdt, cdn, "cargi", soi.cargi);
    frappe.model.set_value(cdt, cdn, "tapicirane_na_gotovi_konstrukcii", soi.tapicirane_na_gotovi_konstrukcii);
    frappe.model.set_value(cdt, cdn, "tabla_razmeri", soi.tabla_razmeri);
    frappe.model.set_value(cdt, cdn, "cagari_h", soi.cagari_h);
    frappe.model.set_value(cdt, cdn, "cagari_d", soi.cagari_d);
    frappe.model.set_value(cdt, cdn, "dve_g_obrazni", soi.dve_g_obrazni);
    frappe.model.set_value(cdt, cdn, "edna_p_obrazna", soi.edna_p_obrazna);
    frappe.model.set_value(cdt, cdn, "three", soi.three);
    frappe.model.set_value(cdt, cdn, "separate", soi.separate);
    frappe.model.set_value(cdt, cdn, "size_matrac", soi.size_matrac);
    frappe.model.set_value(cdt, cdn, "thinkness_matrac", soi.thinkness_matrac);
    frappe.model.set_value(cdt, cdn, "height_sitting", soi.height_sitting);
    frappe.model.set_value(cdt, cdn, "sinking_matrac", soi.sinking_matrac);
    frappe.model.set_value(cdt, cdn, "under_matric_by_dimela", soi.under_matric_by_dimela);
    frappe.model.set_value(cdt, cdn, "under_matric_order", soi.under_matric_order);
    frappe.model.set_value(cdt, cdn, "under_matric_metal", soi.under_matric_metal);
    frappe.model.set_value(cdt, cdn, "under_matric_wood", soi.under_matric_wood);
    frappe.model.set_value(cdt, cdn, "with_mechanics_for_lifting", soi.with_mechanics_for_lifting);
    frappe.model.set_value(cdt, cdn, "under_matric_no_mechanic", soi.under_matric_no_mechanic);
    frappe.model.set_value(cdt, cdn, "inner_base_by_dimela", soi.inner_base_by_dimela);
    frappe.model.set_value(cdt, cdn, "inner_no_mechanic", soi.inner_no_mechanic);
    frappe.model.set_value(cdt, cdn, "inner_mechanic", soi.inner_mechanic);
    ...
    frappe.model.set_value(cdt, cdn, "divan_pcollection_1_size", soi.divan_pcollection_1_size);
    ...
    frappe.model.set_value(cdt, cdn, "divan_pcollection_2_size", soi.divan_pcollection_2_size);
    ...
    frappe.model.set_value(cdt, cdn, "divan_pcollection_3_size", soi.divan_pcollection_3_size);
